...
export function PullRequestDetailGhost() {
  return (
    <div
      role="status"
      aria-label={i18next.t("Loading pull request")}
...
export function PullRequestPeopleGhost({ rows = 4 }: { rows?: number }) {
  return (
    <div
      role="status"
      aria-label={i18next.t("Loading people")}
...
export function PullRequestTimelineGhost({ rows = 6 }: { rows?: number }) {
  return (
    <div
      role="status"
      aria-label={i18next.t("Loading timeline")}
...
export function PullRequestConversationGhost({ rows = 3 }: { rows?: number }) {
  return (
    <div
      role="status"
      aria-label={i18next.t("Loading pull request conversation")}
